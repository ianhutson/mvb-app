    ...
    <View style={styles.container}>
      ...
      <View style={styles.section}>
        ...
        <Text style={styles.sectionSubtitle}>
          Choose how volume is shown on scans
        </Text>
        <View style={styles.unitSelector}>
          <TouchableOpacity
            style={[
              styles.unitOption,
              volumeUnit === "ml" && styles.unitOptionActive,
            ]}
          ...
          >
            <Text
              style={[
                ...
                volumeUnit === "ml" && styles.unitOptionTextActive,
              ]}
            >
              mL
            </Text>
          ...
          <TouchableOpacity
            style={[
              styles.unitOption,
              volumeUnit === "floz" && styles.unitOptionActive,
            ]}
          ...
          >
            <Text
              style={[
                styles.unitOptionText,
                volumeUnit === "floz" && styles.unitOptionTextActive,
              ]}
            >
              fl oz
            </Text>
